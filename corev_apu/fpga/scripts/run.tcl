...
# hard-coded to arty-a7 for the moment

if {$::env(BOARD) eq "Arty-A7"} {
    add_files -fileset constrs_1 -norecurse constraints/Arty-A7.xdc
...
if {$::env(BOARD) eq "Arty-A7"} {
    read_verilog -sv {src/arty-a7.svh ../../vendor/pulp-platform/common_cells/include/common_cells/registers.svh}
    set file "src/arty-a7.svh"

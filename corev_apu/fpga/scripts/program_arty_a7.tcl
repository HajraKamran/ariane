...
# Program arty-a7 FPGA board connected to $HW_SERVER_URL with bitstream ../work-fpga/ariane_xilinx.bit
...
set_property PROGRAM.FILE {../work-fpga/ariane_xilinx.bit} [get_hw_device xc7a100tcsg324-1]

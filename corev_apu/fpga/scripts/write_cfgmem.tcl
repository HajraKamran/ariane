...
# Description: Generate a memory configuration file from a bitstream (arty-a7 only right now)
...
# https://scholar.princeton.edu/jbalkind/blog/programming-arty-a7-qspi-spi-x4-flash
